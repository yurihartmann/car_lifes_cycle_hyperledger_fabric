...
generateArtifacts() {
  ...
  printItalics "Generating crypto material for concessionariaF" "U1F512"
  certsGenerate "$FABLO_NETWORK_ROOT/fabric-config" "crypto-config-concessionariaf.yaml" "peerOrganizations/concessionaria-f.car-lifes-cicle.com" "$FABLO_NETWORK_ROOT/fabric-config/crypto-config/"

  printItalics "Generating crypto material for concessionariaG" "U1F512"
  certsGenerate "$FABLO_NETWORK_ROOT/fabric-config" "crypto-config-concessionariag.yaml" "peerOrganizations/concessionaria-g.car-lifes-cicle.com" "$FABLO_NETWORK_ROOT/fabric-config/crypto-config/"
...
installChannels() {
  ...
  printItalics "Joining 'car-channel' on  concessionariaF/peer0" "U1F638"
  docker exec -i cli.concessionaria-f.car-lifes-cicle.com bash -c "source scripts/channel_fns.sh; fetchChannelAndJoin 'car-channel' 'concessionariaFMSP' 'peer0.concessionaria-f.car-lifes-cicle.com:7101' 'crypto/users/Admin@concessionaria-f.car-lifes-cicle.com/msp' 'orderer0.orderers-group.detran.car-lifes-cycle.com:7030';"
  printItalics "Joining 'car-channel' on  concessionariaG/peer0" "U1F638"
  docker exec -i cli.concessionaria-g.car-lifes-cicle.com bash -c "source scripts/channel_fns.sh; fetchChannelAndJoin 'car-channel' 'concessionariaGMSP' 'peer0.concessionaria-g.car-lifes-cicle.com:7121' 'crypto/users/Admin@concessionaria-g.car-lifes-cicle.com/msp' 'orderer0.orderers-group.detran.car-lifes-cycle.com:7030';"
  ...
  printItalics "Joining 'person-channel' on  concessionariaF/peer0" "U1F638"
  docker exec -i cli.concessionaria-f.car-lifes-cicle.com bash -c "source scripts/channel_fns.sh; fetchChannelAndJoin 'person-channel' 'concessionariaFMSP' 'peer0.concessionaria-f.car-lifes-cicle.com:7101' 'crypto/users/Admin@concessionaria-f.car-lifes-cicle.com/msp' 'orderer0.orderers-group.detran.car-lifes-cycle.com:7030';"
  printItalics "Joining 'person-channel' on  concessionariaG/peer0" "U1F638"
  docker exec -i cli.concessionaria-g.car-lifes-cicle.com bash -c "source scripts/channel_fns.sh; fetchChannelAndJoin 'person-channel' 'concessionariaGMSP' 'peer0.concessionaria-g.car-lifes-cicle.com:7121' 'crypto/users/Admin@concessionaria-g.car-lifes-cicle.com/msp' 'orderer0.orderers-group.detran.car-lifes-cycle.com:7030';"
...
installChaincodes() {
  if [ -n "$(ls "$CHAINCODES_BASE_DIR/./chaincodes/car-chaincode")" ]; then
    ...
    printHeadline "Installing 'car' for concessionariaF" "U1F60E"
    ...
    printHeadline "Installing 'car' for concessionariaG" "U1F60E"
  ...
  if [ -n "$(ls "$CHAINCODES_BASE_DIR/./chaincodes/person-chaincode")" ]; then
    ...
    printHeadline "Installing 'person' for concessionariaF" "U1F60E"
    ...
    printHeadline "Installing 'person' for concessionariaG" "U1F60E"
...
runDevModeChaincode() {
  ...
  if [ "$chaincodeName" = "car" ]; then
    ...
    printHeadline "Approving 'car' for concessionariaF (dev mode)" "U1F60E"
    ...
    printHeadline "Approving 'car' for concessionariaG (dev mode)" "U1F60E"
  ...
  if [ "$chaincodeName" = "person" ]; then
    ...
    printHeadline "Approving 'person' for concessionariaF (dev mode)" "U1F60E"
    ...
    printHeadline "Approving 'person' for concessionariaG (dev mode)" "U1F60E"
...
notifyOrgsAboutChannels() {
  ...
  createNewChannelUpdateTx "car-channel" "concessionariaFMSP" "CarChannel" "$FABLO_NETWORK_ROOT/fabric-config" "$FABLO_NETWORK_ROOT/fabric-config/config"
  createNewChannelUpdateTx "car-channel" "concessionariaGMSP" "CarChannel" "$FABLO_NETWORK_ROOT/fabric-config" "$FABLO_NETWORK_ROOT/fabric-config/config"
  ...
  createNewChannelUpdateTx "person-channel" "concessionariaFMSP" "PersonChannel" "$FABLO_NETWORK_ROOT/fabric-config" "$FABLO_NETWORK_ROOT/fabric-config/config"
  createNewChannelUpdateTx "person-channel" "concessionariaGMSP" "PersonChannel" "$FABLO_NETWORK_ROOT/fabric-config" "$FABLO_NETWORK_ROOT/fabric-config/config"
  ...
  notifyOrgAboutNewChannel "car-channel" "concessionariaFMSP" "cli.concessionaria-f.car-lifes-cicle.com" "peer0.concessionaria-f.car-lifes-cicle.com" "orderer0.orderers-group.detran.car-lifes-cycle.com:7030"
  notifyOrgAboutNewChannel "car-channel" "concessionariaGMSP" "cli.concessionaria-g.car-lifes-cicle.com" "peer0.concessionaria-g.car-lifes-cicle.com" "orderer0.orderers-group.detran.car-lifes-cycle.com:7030"
  ...
  notifyOrgAboutNewChannel "person-channel" "concessionariaFMSP" "cli.concessionaria-f.car-lifes-cicle.com" "peer0.concessionaria-f.car-lifes-cicle.com" "orderer0.orderers-group.detran.car-lifes-cycle.com:7030"
  notifyOrgAboutNewChannel "person-channel" "concessionariaGMSP" "cli.concessionaria-g.car-lifes-cicle.com" "peer0.concessionaria-g.car-lifes-cicle.com" "orderer0.orderers-group.detran.car-lifes-cycle.com:7030"
  ...
  deleteNewChannelUpdateTx "car-channel" "concessionariaFMSP" "cli.concessionaria-f.car-lifes-cicle.com"
  deleteNewChannelUpdateTx "car-channel" "concessionariaGMSP" "cli.concessionaria-g.car-lifes-cicle.com"
  ...
  deleteNewChannelUpdateTx "person-channel" "concessionariaFMSP" "cli.concessionaria-f.car-lifes-cicle.com"
  deleteNewChannelUpdateTx "person-channel" "concessionariaGMSP" "cli.concessionaria-g.car-lifes-cicle.com"
